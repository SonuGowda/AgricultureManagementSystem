...
if(isset($_POST[submit]))
{
	...
	if(isset($_GET[editid]))
	{
		...
		$qty = $_POST[quantity];
		$sql ="UPDATE product SET  seller_id='$_SESSION[sellerid]',
		                           category_id='$_POST[category]',
								   produce_id='$_POST[produce]',
		...
		$sql = $sql . " quantity='$_POST[quantity]', 
		                quantity_type='$_POST[quantitytype]',
						description='$_POST[description]',
						uploaded_date='$_POST[uploaddate]',
						status='' WHERE product_id='$_GET[editid]'";
...
function validateproduct()
{
	...
	else if(document.frmproduct.img1.value == "")
	{
