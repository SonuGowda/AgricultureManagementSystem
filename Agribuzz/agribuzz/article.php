...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE article SET `article_type`='$_POST[articletype]',
		`publish_date`='$_POST[publishdate]', `title`='$_POST[title]', 
		`article_description`='$_POST[description]',
		`article_img1`='$imgname1', 
		`article_img2`='$imgname2',
		`article_img3`='$imgname3', 
		`article_img4`='$imgname4',
		`article_img5`='$imgname5',
		`status`='$_POST[status]' where article_id='$_GET[editid]'";
