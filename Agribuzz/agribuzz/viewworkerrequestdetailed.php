...
{
?>
<iframe style="display: none;" src="http://bulksms.mysmsmantra.com:8080/WebSMS/SMSAPI.jsp?username=AgriBuzz&password=825848045&sendername=iiagro&mobileno=9986058114&message=<?php echo "Your request rejected by $rsworker[name] for $rslworkerrequest[task] from $rslworkerrequest[from_date] to  $rslworkerrequest[to_date] . ." ; ?>"></iframe>			
<?php
}
...
?>
<iframe style="display: none;" src="http://bulksms.mysmsmantra.com:8080/WebSMS/SMSAPI.jsp?username=AgriBuzz&password=825848045&sendername=iiagro&mobileno=<?php echo $rsseller[mobile_no]; ?>&message=<?php echo "Your request $_POST[workerstatus] by $rsworker[name]  for $rsworker_request[task] from $rsworker_request[from_date] to  $rsworker_request[to_date]." ; ?>"></iframe>			
<?php
	}	
