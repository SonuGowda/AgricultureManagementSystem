...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="UPDATE worker SET name='$_POST[name]',
		address='$_POST[address]',
		state_id='$_POST[state]',
		city_id='$_POST[city]',
		country_id='$_POST[country]',
		pincode='$_POST[pincode]',
		contactno='$_POST[contct]',
		work_profile='$_POST[workprofile]',
		 date_of_birth='$_POST[dob]',
		 login_id='$_POST[loginid]',
		 password='$_POST[password]',
		 expected_salary='$_POST[expectedsalary]', 
		 status='Active'";
	...
	{
$sql="INSERT INTO worker(worker_id, name, address, state_id, city_id, country_id, pincode, contactno, work_profile,date_of_birth, login_id, password, expected_salary, status) VALUES ('','$_POST[name]','$_POST[address]','$_POST[state]','$_POST[city]','$_POST[country]','$_POST[pincode]','$_POST[contct]','$_POST[workprofile]','$imgname1','$_POST[dob]','$_POST[loginid]','$_POST[password]','$_POST[expectedsalary]','Active')";
if(!mysqli_query($con,$sql))
	{
		echo "Error in mysqli query";
	}
