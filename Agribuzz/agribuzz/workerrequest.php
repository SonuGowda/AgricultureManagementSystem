...
?>
//iframe src="http://bulksms.mysmsmantra.com:8080/WebSMS/SMSAPI.jsp?username=AgriBuzz&password=825848045&sendername=iiagro&mobileno=<?php echo $rsworker[contactno]; ?>&message=<?php echo "You have got work request from $rsseller[seller_name] for $_POST[task] from $_POST[fromdate] to  $_POST[tilldate] . Kindly login the website to approve/reject the request.." ; ?>"></iframe>
<?php
